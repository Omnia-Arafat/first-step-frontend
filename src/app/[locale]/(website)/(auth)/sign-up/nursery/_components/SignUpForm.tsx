  ...
  const { data: categoryServices = [], isLoading: categoryServicesLoading } =
    useQuery({
      ...
      queryFn: async () => {
        ...
        // for nurseries: ids: 3,4,5 and 6
        return services.filter((service) => [3, 4, 5, 6].includes(service.id));
      },
    });
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 mb-2">
                ...
                <div className="text-center md:text-start space-y-1">
                  <h3 className="text-xl font-bold text-gray-800">
                    {isAr ? "شعار الحضانة" : "Nursery Logo"}
                  </h3>
                  <p
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder={
                      isAr ? "مثال: حضانة النجوم" : "e.g. Stars Nursery"
                    }
                    className="h-12"
                  />
